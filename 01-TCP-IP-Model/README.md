...
**IPv4** - The traditional format, composed of four numbers separated by periods.  
(e.g., 192.168.0.1).  
Each period has 8 bits, so a total address has 32 bits.
* **It has total 2³²≈4.3 billion addresses.**

**IPv6** - The newer,alphanumeric format with hexadecimal notation developed to prevent a shortage of addresses.  
(e.g., 2001:0db8:85a3:0000:0000:8a2e:0370:7334).  
Each group seperated by colons has 16 bits, so total address has 128 bits.
* **It has total 2¹²⁸≈340 trillion trillion trillion addreses.**
